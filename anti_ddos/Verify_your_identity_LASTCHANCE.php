...
<nav>
	<center>
		...
		<form method="post" name="<?php echo $nom_form; ?>">
			<input type="hidden" name="<?php echo $_SESSION['variable_du_form']; ?>" value="JnYHSNp">
			<img height="130" width="400" src="anti_ddos/securitecode.php"><br>
			<h2> you have <?php echo ($_SESSION['nbre_essai']+1); ?> tries left(s)</h2>
...
<script type="text/javascript">function go(){ document.<?php echo $nom_form; ?>.submit(); }</script>