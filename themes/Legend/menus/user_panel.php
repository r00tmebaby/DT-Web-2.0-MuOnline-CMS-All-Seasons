<?php if (isset($_SESSION['dt_username'])){
	$set=web_settings();	$acc_chars  = mssql_fetch_array(mssql_query("Select * from [character] where [accountID] = '".$_SESSION['dt_username']."'")); 
	$memb_info  = mssql_fetch_array(mssql_query("Select * from [Memb_info] where [memb___id] = '".$_SESSION['dt_username']."'"));
	$played     = mssql_fetch_array(mssql_query("Select GAMEIDC from [AccountCharacter] where [id] = '".$_SESSION['dt_username']."'"));	$memb_stat  = mssql_fetch_array(mssql_query("Select * from [memb_stat] where [memb___id] = '".$_SESSION['dt_username']."'"));
